...
RSAtest:
	g++ -std=c++11 -g -I cppunit/usr/include/ -L cppunit/usr/lib/ -lm -ldl -lcppunit -lgmp RSA/RSATestCase.cpp RSA/Main.cpp RSA/crypt.cpp RSA/rsa_keygen.cpp RSA/fermat_att.cpp RSA/pollard_att.cpp $(bigint-objects) -o RSAtest
Stegotest:
